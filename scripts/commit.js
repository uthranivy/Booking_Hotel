 let headerTemplate = () =>{
     ...
     <a href="index.html">
     <img src="assests/images/logo.png" class="logo" id="logo-image" alt="logo"/></a> 
                <button type="button" id="login" class="btn btn-light btn-sm" data-toggle="modal" data-backdrop="false" data-target="#login-modal" onclick="headerLogin(event)">LOGIN</button>
...
let login = (event) =>{
    ...
    if(userElement.value === "admin" && passwordElement.value ==="admin"){
        localStorage.setItem("isUserLoggedIn","true");
        alert("Successfully Logged In!");
        document.getElementById("login").innerText = "LOGOUT";
        location.reload();
    }else{
        alert("Invalid Credentialist, Login Failed!");
    }
    userElement.value = "";
